...
<html lang="ja">
  ...
  <body>
      <div class="container">
        <div class="wrapper">
           <form action="comment_form.php" method="post" class="form-comment">
              <h2 class="form-comment-heading">コメントフォーム</h2>
                 ...
                 <?php if( !empty($errors)): ?>
                  ...
                  <?php endif; ?>
                  <h5>親記事内容：</h5>
                  <b><?php echo $parent_content; ?></b><br>
                  <br>
                  <h5>ユーザー名：</h5>
                  ...
                  <br>
                  <button class="btn btn-lg btn-primary btn-block" name="comment" type="submit">コメントする</button><br>
